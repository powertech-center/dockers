#!/bin/sh
# test.sh — Test runner for alpine-cross-csharp
#
# Usage:
#   ./test.sh                         # run all tests
#   ./test.sh 01-dotnet-sdk           # run specific test
#   ./test.sh --target musl           # filter by target
...
printf "${BOLD}Running C# (.NET) cross-compilation tests${RESET}\n\n"
